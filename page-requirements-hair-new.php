...
<section id="requirements">
    ...
    <div class="require_container">
        <ul class="flex require_tab pc_flex">
            <li>
                <a href="/requirements-hair-new"  class="active">HAIR｜新卒採用</a>
            </li>
            <li>
        ...
        <dl class="flex">
            <dt>給与</dt>
            <dd>月給 ¥205,000~（基本給 ¥190,000）<br><br>
                ※みなし残業手当 ¥15,000~を含む。超過分は別途支給<br>
                ※試用期間3~6ヶ月（期間中：条件変更なし）<br>
                ・昇給あり<br>
                ・賞与年2回支給<br>
                ・交通費支給あり（上限 ¥15,000~20,000/月）</dd>
        </dl>
        <dl class="flex">
            <dt>勤務時間</dt>
            <dd>実働8時間 （休憩2時間）<br>
...
<?php include("template/recruit-flow.php"); ?>
