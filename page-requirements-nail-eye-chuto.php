...
<section id="requirements">
    ...
    <div class="require_container">
        <ul class="flex require_tab pc_flex">
            ...
            <li>
                <a href="/requirements-nail-eye-new">NAIL&EYE｜新卒採用</a>
            </li>
            <li>
                <a href="/requirements-nail-eye-chuto" class="active">NAIL&EYE｜中途採用</a>
            </li>
        </ul>
